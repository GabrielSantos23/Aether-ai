...
export const createMessage = async (
  ...
  return await db.transaction("rw", [db.messages, db.threads], async () => {
    await db.messages.add({
      ...
      sources: sources || message.sources || [], // Store sources with the message
      reasoning: message.reasoning || "", // Store reasoning with the message
    });
...
export const updateMessageSources = async (
  messageId: string,
  sources: SearchSource[]
) => {
...
export const updateMessageReasoning = async (
  messageId: string,
  reasoning: string
) => {
  return await db.messages.update(messageId, {
